...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Liste de personne avec id supérieur au paramètre set");
        ...
        System.out.println("Personne avec l'ID 1 (avant modification)" +personne3.getNom()+" "+personne3.getPrenom());
        ...
        System.out.println("Personne avec l'ID 1 (après modification)" +personne4.getNom()+" "+personne4.getPrenom());
